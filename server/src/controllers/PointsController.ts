...
class PointsController {
  ...
  async index(request: Request, response: Response) {
    ...
    // Filtros opcionais: city, uf, items (Query Params / Query String)
  ...
  async show(request: Request, response: Response) {
    ...
    // Usando destructing assignment do ES6.
  ...
  async create(request: Request, response: Response) {
    ...
    await trx.commit();
    // Se houve falha trx.rollback() porém o rollback já está como automático.
